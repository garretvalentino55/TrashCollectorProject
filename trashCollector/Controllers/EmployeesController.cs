...
namespace trashCollector.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Employee.Include(e => e.IdentityEmployee);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeNumber,Name,EmployeeZipCode,IdentityEmployeeId")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
